...
<body>
  <div class="container text-center">
    ...
    <form action="index.php" method="POST">
      <div class="form-group">
        <label for="">Número de Fibonacci</label>
        <input type="text" class="form-control" id="num_fibonacci" name="num_fibonacci" placeholder="Escribe un número aqui">
      </div>
      <div class="form-group">
  ...
  <h2 class="my-3 text-center">
    Número Fibonacci: <?php echo $numFibonacci ?>
  </h2>
